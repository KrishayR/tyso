...
newHeader.innerText = 'Exercise: Push Up';
...
function onResultsPose(results) {
  ...
  const nose = [results.poseLandmarks[0].x, results.poseLandmarks[0].y];
...
let text = "Slowly move your body downwards until your chest hits the ground.";
feedbackDisplay.textContent = text;
// Curling logic
if (left_elbow[1]*100 < nose[1] * 100 && right_elbow[1] * 100 < nose[1] * 100) {
    if ((left_shoulder[1]*100 - left_elbow[1]*100 >= 0) && (right_shoulder[1]*100 - right_elbow[1]*100 >= 0)){
        down = true
        let text = "Now move your body up slowly, squeezing your elbows in as much as possible.";
        feedbackDisplay.textContent = text;
    }
    if ((left_shoulder[1]*100 - left_elbow[1]*100 <= 5) && (right_shoulder[1]*100 - right_elbow[1]*100 <= 5) && (down)){
        let text = "Slowly move your body downwards until your chest hits the ground.";
        feedbackDisplay.textContent = text;
        down = false
        counter += 1;
